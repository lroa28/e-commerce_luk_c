...
routerMascotas.use(express.urlencoded({extended: true}))//para parsear todos los bodys
routerPersonas.use(express.urlencoded({extended: true}))//para parsear todos los bodys 
