...
import carritoModel, { findOne } from '../models/carritos.js';
import { findOne as _findOne } from '../models/productos.js';
...
const addProducto = async (req, res, next) => {
    ...
    let cart = await findOne({ userID: userID });
    let product = await _findOne({_id: productID});
